	...
	return {
		...
		contents: [{
			...
			elements: [{
				...
				items: [["", ""]],
				setup: function() {
					var selectEl = $("#" + this.getInputElement().$.id);
					$.ajax({
						url: "/admin/pages/select_box_options",
						type: "GET",
						format: "JSON",
				...
				onChange: function() {
					...
					var urlTextField = $("#" + dialog.getContentElement("info", "url")
						.getInputElement().$.id);

					urlTextField.val("remixgold.ru/" + pageUrl);
				}
